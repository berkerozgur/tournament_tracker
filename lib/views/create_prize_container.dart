...
class CreatePrizeContainer extends StatefulWidget {
  const CreatePrizeContainer({super.key});

  @override
  State<CreatePrizeContainer> createState() => _CreatePrizeContainerState();
}

class _CreatePrizeContainerState extends State<CreatePrizeContainer> {
